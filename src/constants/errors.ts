const ERROR_MESSAGES = {
    USER_IS_ALREADY_EXIST: "User already exists. Please check the phone number or email.",
    INVALID_EMAIL_FORMAT: "The email format is invalid.",
    MISSING_REQUIRED_FIELDS: "Required fields are missing.",
    USER_NOT_FOUND: "User not found.",
    UNAUTHORIZED_ACCESS: "Unauthorized access.",
    INTERNAL_SERVER_ERROR: "An internal server error occurred. Please try again later.",
    CUSTOMER_ALREADY_EXIST: "Customer already exists. Please check the phone number.",
    PRODUCT_ALREADY_EXIST: "Product already exists. Please check the product code.",
