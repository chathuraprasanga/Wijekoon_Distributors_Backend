...
chequePaymentRoute.post("/cheque-payment", authMiddleware, createChequePaymentController);
chequePaymentRoute.post("/cheque-payments", authMiddleware, getAllChequePaymentsController);
chequePaymentRoute.post("/paged-cheque-payments", authMiddleware, getPagedChequePaymentsController);
